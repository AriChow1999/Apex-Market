...
const fetchMobilesProducts = async () => {
    ...
    <div className="apex-sportswear-page">
      ...
      <div className="apex-sportswear-hero">
        <div className="apex-sportswear-search-container">
          <h1>Mobile Phones Collection</h1>
          <p>Explore cutting-edge smartphones, flagship devices, and mobile tech.</p>
          <div className="apex-search-bar-wrapper">
            <Search size={18} className="apex-search-icon" />
            <input
              type="text"
              placeholder="search in mobiles..."
              value={searchQuery}
      ...
      <div className="apex-products-container">
        <div className="apex-products-header">
          <h2>Featured Mobiles ({filteredProducts.length})</h2>
        </div>
        ...
        {loading ? (
          ...
          <div className="apex-error-state">
            <p>{error.response?.data?.message || error.message || 'Failed to fetch mobile phones.'}</p>
          </div>
        ) : (
          <>
            <div className="apex-products-grid">
              {currentProducts.length > 0 ? (
                ...
                <div className="apex-no-results">
                  <p>No mobile phones found matching "{searchQuery}".</p>
                </div>
              )}
            </div>
